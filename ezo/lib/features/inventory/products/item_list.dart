...
import 'package:aeropos/core/widgets/product_image.dart';
      ...
      child: Row(
        children: [
          ...
          Expanded(
            flex: 1,
            child: Icon(
              product.syncStatus == 0 ? Icons.check_circle : Icons.cloud_upload,
              color: product.syncStatus == 0 ? Colors.green : Colors.orange,
              size: 18,
            ),
          ),
          Expanded(
